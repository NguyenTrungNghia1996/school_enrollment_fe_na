    ...
    <div class="w-full max-w-[440px]">
      ...
      <div class="mb-8 flex flex-col items-center">
        <div class="relative mb-6">
          <div class="bg-primary absolute -inset-1 rounded-full opacity-20 blur-lg"></div>
      ...
      <a-card :bordered="false" class="login-card overflow-hidden shadow-[0_8px_30px_rgb(0,0,0,0.12)]">
        ...
        <a-form :model="form" layout="vertical" @finish="handleLogin" autocomplete="off" class="mt-2">
          ...
          <a-form-item class="mb-0">
            <a-button type="primary" html-type="submit" size="large" block :loading="loading" class="shadow-primary/20 h-12 !rounded-lg !text-base !font-bold shadow-md">Đăng Nhập</a-button>
          </a-form-item>
        </a-form>
      </a-card>
...
const handleLogin = async values => {
  ...
  try {
    ...
    if (data.value) {
      ...
      message.success("Chào mừng bạn trở lại hệ thống!");
