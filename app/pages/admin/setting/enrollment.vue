<template>
  <div class="min-h-full bg-white p-2 md:p-4">
    ...
    <a-modal
      ...
      :title="isEdit ? 'Chỉnh sửa kỳ tuyển sinh' : 'Thêm mới kỳ tuyển sinh'"
      @cancel="handleCancel"
      :width="700"
    ...
    >
      <a-form ref="formRef" :model="formState" :rules="rules" layout="vertical" class="mt-4 max-h-[70vh] overflow-y-auto pr-2" @submit.prevent>
        <a-alert
          ...
          show-icon
          class="mb-4"
          message="Kỳ tuyển sinh đã có hồ sơ đăng ký. Chỉ được phép cập nhật thời gian phúc khảo và lệ phí phúc khảo."
        />
