              ...
              <section class="pb-10">
                ...
                <div class="grid gap-4 lg:grid-cols-1">
                  <div class="rounded-2xl border border-amber-100 bg-amber-50/40 p-5">
                    <UserSelectPriorityPoint v-model="formState.id_priority_point" name="id_priority_point" size="large" />
                  </div>
                  <div class="rounded-2xl border border-emerald-100 bg-emerald-50/40 p-5">
                    <UserSelectBonusPoint v-model="formState.id_bonus_point" name="id_bonus_point" size="large" />
                  </div>
                </div>
              </section>
