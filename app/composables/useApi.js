export const useApi = () => {
  ...
  return {
    ...
    adminSignatureList: useCrudApiAdmin("/api/admin/examList/export-signature-list"),
    adminSignatureImageList: useCrudApiAdmin("/api/admin/examList/export-signature-list-image"),
    adminSignatureImageStatus: useCrudApiAdmin("/api/admin/examList/export-signature-list-image-status"),
